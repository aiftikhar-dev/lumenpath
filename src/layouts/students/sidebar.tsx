...
export function StudentSidebar({ onShowOnboarding }: StudentSidebarProps) {
  const { state, handleTabChange, activeTab } = useSidebar();
    ...
    >
      <SidebarContent className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-auto">
          <SidebarGroup>
            <SidebarGroupLabel
              className={state === "collapsed" ? "sr-only" : ""}
            >
              Main
            </SidebarGroupLabel>
            <SidebarGroupContent>
                    ...
                    <SidebarMenuItem key={item.id}>
                      <SidebarMenuButton asChild>
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-3 py-2 text-left rounded-md transition-colors ${getNavCls(
                            item.id
                          )}`}
                        >
        ...
        <div className="p-4 border-t space-y-2">
          <Button
            ...
            size="sm"
            className={`w-full ${
              state === "collapsed" ? "px-2" : "justify-start"
